...
export const catalogSlice = createSlice({
    name: 'catalog',
    initialState: productsAdapater.getInitialState<CatalogState>({
    ...
    reducers: {
        ...
        removeProduct: (state, action) => {
            productsAdapater.removeOne(state, action.payload);
            state.productsLoaded = false;
        },
...
export const productsSelector = productsAdapater.getSelectors((state: RootState) => state.catalog);
